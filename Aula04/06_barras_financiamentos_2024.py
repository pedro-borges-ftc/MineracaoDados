...
# Criando um gráfico de barras com seaborn para o valor de financiamento ao longo dos anos
plt.figure(figsize=(10, 5))
sns.barplot(x="num_ano_financiamento", y="vlr_financiamento", data=df, palette="Blues")
